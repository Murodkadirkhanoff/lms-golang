-- enrollment moduli: yozilishlar, dars kirishlari, buyurtmalar,
-- sertifikatlar, bildirishnomalar
-- (Go: backend/enrollment-service/migrations/000001, 000002)
-- user_id / course_id / lesson_id boshqa modullarga ishora — FK YO'Q.
